...
import type { WebhookDelivery, WebhookEndpoint } from "@/lib/db/schema";
...
export default function WebhooksPage() {
	...
	const [newSecretBanner, setNewSecretBanner] =
		useState<NewSecretBanner | null>(null);
	...
	async function handleToggle(endpointId: string, isActive: boolean) {
		...
		setEndpoints((prev) =>
			prev.map((e) =>
				e.id === endpointId ? { ...e, isActive: !isActive } : e,
			),
		);
	}
	...
	return (
		<div className="mx-auto max-w-3xl p-6 lg:p-8">
			...
			{showCreate && (
				...
				>
					<h2 className="mb-4 text-base font-semibold text-[#292d4c]">
