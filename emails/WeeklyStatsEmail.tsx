				...
				<Container style={container}>
					...
					<Section style={content}>
						...
						<Text style={subheading}>
							Here&apos;s how your page performed this week:
						</Text>
						...
						<Section style={statsGrid}>
							<Section style={statCard}>
								...
								<Text style={statDelta(viewsDelta)}>
							...
							<Section style={statCard}>
								...
								<Text style={statDelta(clicksDelta)}>
						...
						{topLinks.length > 0 && (
							<>
								...
								{topLinks.slice(0, 3).map((link, i) => (
									// biome-ignore lint/suspicious/noArrayIndexKey: email items have no stable id
