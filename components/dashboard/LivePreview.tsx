 ...
 */
export function LivePreview({ theme, displayName = "Your Name", bio = "Your bio here" }: LivePreviewProps) {
  ...
  function linkStyle(): CSSProperties {
    ...
    switch (btnStyle) {
      case "filled":
        return { ...base, backgroundColor: theme.buttonColor, color: theme.buttonTextColor };
      case "outline":
        return { ...base, backgroundColor: "transparent", color: theme.buttonColor, border: `2px solid ${theme.buttonColor}` };
      case "soft":
        return { ...base, backgroundColor: `${theme.buttonColor}22`, color: theme.buttonColor };
      case "shadow":
        return { ...base, backgroundColor: "#ffffff", color: theme.textColor, boxShadow: "0 2px 8px rgba(0,0,0,0.12)" };
      default:
        return base;
    }
  }
