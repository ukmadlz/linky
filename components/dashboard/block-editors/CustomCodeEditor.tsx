...
export function CustomCodeEditor({ block, onSave, onCancel }: CustomCodeEditorProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="rounded-lg border border-amber-200 bg-amber-50 px-3 py-2.5 text-xs text-amber-700">
        <strong>Allowed HTML:</strong> div, span, p, a, img, ul, ol, li,
        h1–h6, strong, em, br, iframe (from allowed domains).{" "}
      ...
      <div>
        ...
        <p className="mt-1 text-xs text-slate-400">
          CSS is automatically scoped to this block&apos;s container — your styles won&apos;t affect the rest of the page.
        </p>
      </div>
