...
export function EmailCollectEditor({
	block,
	onSave,
	onCancel,
}: EmailCollectEditorProps) {
		...
		<div className="flex flex-col gap-4">
			...
			<div className="flex flex-col gap-1.5">
				...
				<p className="text-xs text-slate-500">
					Paste the embed code from your email provider. This will be rendered
					as-is.
				</p>
				<textarea
					id="embed-code"
			...
			<div className="rounded-lg border border-amber-200 bg-amber-50 px-3 py-2 text-xs text-amber-700">
				Only paste embed code from trusted providers. Arbitrary HTML is rendered
				directly.
			</div>
