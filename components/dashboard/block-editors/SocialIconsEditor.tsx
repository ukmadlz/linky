		...
		<form onSubmit={handleSubmit} className="space-y-4">
			<div>
				...
				<div className="space-y-2">
					{icons.map((icon, i) => (
						// biome-ignore lint/suspicious/noArrayIndexKey: icon list has no stable key
			...
			<div className="flex gap-4">
				<div>
					<p className="mb-1 block text-xs font-medium text-slate-600">Size</p>
				...
				<div>
					<p className="mb-1 block text-xs font-medium text-slate-600">Style</p>
					<div className="flex gap-1">
